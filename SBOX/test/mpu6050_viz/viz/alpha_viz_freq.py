...
def plot_fft(x, ax, scenario):
    ...
    ax.plot(freqs_hz, magnitude_acc, label='accX', color='white', linewidth=0.7)
...
def main():
    ...
    fig, axs = plt.subplots(3, 1, figsize=(15, 5), facecolor='black')  # 1x3 서브플롯 생성
